...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MixocityApp.Droid.SplashScreen, MixocityApp.Android", SplashScreen.class, __md_methods);
	}
	...
	public SplashScreen ()
	{
		...
		if (getClass () == SplashScreen.class)
			mono.android.TypeManager.Activate ("MixocityApp.Droid.SplashScreen, MixocityApp.Android", "", this, new java.lang.Object[] {  });
	}
